  ...
  <html>
   ...
   <body> 
      ...
      <script>
        ...
        {
          if(Empty(document.getElementById("ssid"), "Please enter ssid!")&&Empty(document.getElementById("pass"), "Please enter password")&&Empty(document.getElementById("server"), "Please enter server mqtt")&&Empty(document.getElementById("port"), "Please enter port mqtt"))
          {
